...
wget -q -O /etc/slowdns/server.key "https://raw.githubusercontent.com/KochengVpn/v1/main/ssh/server.key"
wget -q -O /etc/slowdns/server.pub "https://raw.githubusercontent.com/KochengVpn/v1/main/ssh/server.pub"
wget -q -O /etc/slowdns/sldns-server "https://raw.githubusercontent.com/KochengVpn/v1/main/ssh/sldns-server"
wget -q -O /etc/slowdns/sldns-client "https://raw.githubusercontent.com/KochengVpn/v1/main/ssh/sldns-client"
cd
