...
wget https://raw.githubusercontent.com/KochengVpn/v1/main/ssh/cf && chmod +x cf && ./cf
...
# intall slowdns
echo -e "\e[33m-----------------------------------\033[0m"
echo -e "$BGreen      Install SLOWDNS           $NC"
echo -e "\e[33m-----------------------------------\033[0m"
sleep 0.5
clear
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/KochengVpn/v1/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "\e[33m-----------------------------------\033[0m"
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/KochengVpn/v1/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/KochengVpn/v1/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/KochengVpn/v1/main/menu/versi  )
...
echo -e "\e[33;1m           🇲🇨 KOCHENG VPN TUNNEL 🇲🇨 \e[0m"  | tee -a log-install.txt
echo "=================================================================="  | tee -a log-install.txt
echo ""
